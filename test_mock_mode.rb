#!/usr/bin/env ruby
# Test script for Rails API in mock mode (no DhanHQ dependency)

require 'net/http'
require 'json'
require 'uri'

class MockModeTester
  def initialize
...
if __FILE__ == $PROGRAM_NAME
  puts 'Make sure to:'
  puts '1. Set DHAN_CLIENT_ID and DHAN_ACCESS_TOKEN in .env'
  puts '2. Start Rails server: rails server'
  puts '3. This test uses LIVE DhanHQ data'
  puts ''

  tester = MockModeTester.new
